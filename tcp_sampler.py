...
# Function to store the clicked surface
...
# Function to get a point on the surface
...
# Function to sample the surfaces to generate TCP candidates
def generate_TCP():
...
# Function to read the step file
...
# Function to change the selection type
...
# Function to display the coordinate frames
...
# Function to save the frames in a csv file
def save_CSV():
