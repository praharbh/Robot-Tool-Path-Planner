...
# Function to display a coordinate
...
if __name__ == "__main__":
    ...
    # Defining and Intializing global variables and GUI
    ...
    # Vanilla tool-path planner
    if False:
        print('Generating Sequence Path...')
        
        for i in range(0,len(part_pnts)):
    ...
    # Serach-based tool-path planner
    if True:
